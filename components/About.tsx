    ...
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-16">
        ...
        <div className="md:w-1/2 lg:w-[54%] space-y-12 text-gray-700 dark:text-gray-300">
          <h1 className="text-gray-900 dark:text-white font-semibold text-6xl sm:text-6xl md:text-6xl">
            À propos de nous
          </h1>
          <p>
            Nous sommes une équipe jeune et passionnée, réunissant des experts
            en data analyse, statistiques, évaluation de développement, machine
            learning, conduite d'enquêtes de recherche et IT. Notre mission est
            d'aider les organisations à exploiter pleinement leur potentiel
            grâce à des solutions data-driven et des technologies de pointe.
            Nous croyons en l'importance d'un impact mesurable et durable, et

...
const Hero = () => {
  return (
   ...
   font-bold text-gray-900 dark:text-white"
            >
              Optimisez vos projets avec BLY.
            </h1>
            <p className="mt-8 text-gray-700 dark:text-gray-300">
              Nous transformons vos données en actions stratégiques pour un
              impact mesurable grace à des analyses de données précises et des

        ...
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          <div
            className={`
                    ...
                    `}
          >
            <ul className="border-t border-gray-100 dark:border-gray-900 lg:border-t-0 px-6 lg:px-0 pt-6 lg:pt-0 flex flex-col lg:flex-row gap-y-4 gap-x-10 text-lg text-gray-700 dark:text-gray-300 w-full lg:justify-center lg:items-center">
              <li>
                <Link
                  href="#"
          ...
          {/* THIS CODE IS FOR MOBILE RESPONSIVNESS */}
